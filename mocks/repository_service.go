...
import (
	...
	v33github "github.com/google/go-github/v33/github"
)
...
func (_m *RepositoryService) GetRepository(ctx context.Context, owner string, repoName string) (*v33github.Repository, error) {
	ret := _m.Called(ctx, owner, repoName)

	var r0 *v33github.Repository
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *v33github.Repository); ok {
		r0 = rf(ctx, owner, repoName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v33github.Repository)
		}
	}
...
// GetUserRepositoryFork provides a mock function with given fields: ctx, repoName
func (_m *RepositoryService) GetUserRepositoryFork(ctx context.Context, repoName string) (*v33github.Repository, error) {
	ret := _m.Called(ctx, repoName)

	var r0 *v33github.Repository
	if rf, ok := ret.Get(0).(func(context.Context, string) *v33github.Repository); ok {
		r0 = rf(ctx, repoName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v33github.Repository)
...
func (_m *RepositoryService) ListRepositoryForks(ctx context.Context, repoName string) ([]*v33github.Repository, error) {
	ret := _m.Called(ctx, repoName)
